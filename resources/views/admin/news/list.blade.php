                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {!! isset($val->img) ? '<img style="width: 48px; height: 48px; object-fit: cover;" src="data/news/80/'.$val->img.'" class="thumbnail-img align-self-center" alt="" />' : '' !!}
                            </td>
                            <td>
                                {{$val->name}}
                            </td>
                            ...
                            <td class="d-flex pt24px">
                                ...
                                <a href="admin/news/delete/{{$val->id}}"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
