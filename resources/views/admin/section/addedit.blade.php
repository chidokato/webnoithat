...
<form action="admin/section/{{ isset($data) ? 'edit/'.$data->id : 'add' }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-xl-3 col-lg-3">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label>Note</label>
                    <input value="{{ isset($data) ? $data->note : '' }}" type="text" name="note" class="form-control">
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="file-upload">
                    <div class="file-upload-content" onclick="$('.file-upload-input').trigger( 'click' )">
                        <img class="file-upload-image" src="data/section/300/{{ isset($data) ? $data->img : 'no_image.jpg' }}" />
                    </div>
