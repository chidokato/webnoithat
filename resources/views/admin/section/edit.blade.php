...
<div class="row">
    <div class="col-lg-9">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
					<div class="col-md-12">
	                    <label>Name</label>
                        <input value="{{$section->name}}" name='name' type="text" placeholder="name ..." class="form-control" />
	                </div>
		...
		<div class="panel panel-default">
            <div class="panel-body">
                <textarea name="content" class="form-control" id="ckeditor">{!!$section->content!!}</textarea>
            </div>
        </div>
	                ...
	                <div class="col-md-12">
						<div class="file-upload">
                            ...
                            <div class="file-upload-content" style="display: block;">
                                <img class="file-upload-image" src="data/home/{{$section->img}}" />
                            </div>
                        </div>
		        	</div>
              	</div>
